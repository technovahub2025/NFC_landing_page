...
/>
        ...
        <div className="tvh-brand-name">NFC Digital<b>Profile</b></div>
        </div>

        <div className="tvh-tagline">TAP. SCAN. SHARE. UPDATE INSTANTLY.</div>

        {/* Hero */}
        <div className="tvh-hero">Your Digital Business Card,<br /><b>Always Ready to Share</b></div>
        <div className="tvh-hero-sub">
          Create a smart NFC profile with QR sharing, contact saving, social links, and instant updates.
          Share it anywhere in seconds.
        </div>
