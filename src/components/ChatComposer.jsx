  ...
  return (
    <div className="tvh-iarea">
      ...
      <div className="tvh-irow">
        <textarea
          className="tvh-ta"
          placeholder={lang === 'ta' ? 'Ungal kelviya inga type pannunga...' : 'Ask about profile creation, NFC, QR sharing, or contact saving...'}
          value={input}
      ...
      <div className="tvh-fbar">
        <a className="tvh-fbar-brand" href="https://technovahub.in" target="_blank" rel="noopener" aria-label="TechnovaHub website">
          ...
          <span>NFC Profile Assistant</span>
        </a>
        <span>&middot;</span>
        <span>Powered by Gemini AI</span>
        <span>&middot;</span>
        <span>Digital business card system</span>
      </div>
    </div>
  )
}
