...
export default function ChatHeader({
  ...
  const themeGlyph = themeMode === 'dark' ? <Moon size={15} strokeWidth={2.2} /> : themeMode === 'light' ? <SunMedium size={15} strokeWidth={2.2} /> : <Laptop size={15} strokeWidth={2.2} />
  ...
  return (
    <div className="tvh-hd" onMouseDown={onHdDown} onTouchStart={onHdTouch}>
      ...
      <div className="tvh-hd-info">
        <div className="tvh-hd-name">NFC Digital Business Card Assistant</div>
        <div className="tvh-hd-sub">Profile &bull; NFC &bull; QR Sharing</div>
